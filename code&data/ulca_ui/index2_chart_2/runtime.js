...
const {getOwnPropertySymbols: a, prototype: {hasOwnProperty: s}} = Object,
...
function w(n, i, o, a) {
    let s,
        ...
        u,
        d = t(n);
    n instanceof Map ? n instanceof n.constructor ? (s = `Map(${n.size})`, c = y) : (s = "Map()", c = N) : n instanceof Set ? n instanceof n.constructor ? (s = `Set(${n.size})`, c = g) : (s = "Set()", c = N) : d ? (s = `${n.constructor.name}(${n.length})`, c = E) : (u = m(n)) ? (s = `Immutable.${u.name}${"Record" === u.name ? "" : `(${n.size})`}`, d = u.arrayish, c = u.arrayish ? C : u.setish ? x : $) : a ? (s = f(n), c = j) : (s = f(n), c = N);
    ...
    c = c(n);
    for (let e = 0; !(l = c.next()).done && e < 20; ++e)
        p.appendChild(l.value);
    if (!l.done) {
...
function* E(e) {
    for (let t = 0, n = e.length; t < n; ++t)
        t in e && (yield S(t, p(e, t), "observablehq--index"));
    for (const t in e)
        !n(t) && d(e, t) && (yield S(t, p(e, t), "observablehq--key"));
    for (const t of u(e))
        yield S(o(t), p(e, t), "observablehq--symbol")
}
function* C(e) {
    let t = 0;
...
function* j(e) {
    for (const t in v(e))
        yield S(t, p(e, t), "observablehq--key");
    for (const t of u(e))
        yield S(o(t), p(e, t), "observablehq--symbol");
    const t = b(e);
    t && t !== _ && (yield P(t))
...
function* N(e) {
    for (const t in e)
        d(e, t) && (yield S(t, p(e, t), "observablehq--key"));
    for (const t of u(e))
        yield S(o(t), p(e, t), "observablehq--symbol");
    const t = b(e);
    t && t !== _ && (yield P(t))
...
function O(e, n, i, o) {
    let a,
        ...
        l,
        u = t(e);
    if (e instanceof Map ? e instanceof e.constructor ? (a = `Map(${e.size})`, s = L) : (a = "Map()", s = D) : e instanceof Set ? e instanceof e.constructor ? (a = `Set(${e.size})`, s = M) : (a = "Set()", s = D) : u ? (a = `${e.constructor.name}(${e.length})`, s = R) : (l = m(e)) ? (a = `Immutable.${l.name}${"Record" === l.name ? "" : `(${e.size})`}`, u = l.arrayish, s = l.arrayish ? U : l.setish ? k : F) : (a = f(e), s = D), n) {
        const t = document.createElement("span");
...
function* R(e) {
    ...
    for (const n = e.length; r < n; ++r)
        r in e && (r > t + 1 && (yield I(r - t - 1)), yield oe(p(e, r), !0), t = r);
    r > t + 1 && (yield I(r - t - 1));
    for (const t in e)
        !n(t) && d(e, t) && (yield z(t, p(e, t), "observablehq--key"));
    for (const t of u(e))
        yield z(o(t), p(e, t), "observablehq--symbol")
}
function* D(e) {
    for (const t in e)
        d(e, t) && (yield z(t, p(e, t), "observablehq--key"));
    for (const t of u(e))
        yield z(o(t), p(e, t), "observablehq--symbol")
}
function* F(e) {
...
function re(e, t, n) {
    ...
    */
const {prototype: {toString: ie}} = Object;
...
function he(e) {
    var t,
        ...
        i = e.getUTCSeconds(),
        o = e.getUTCMilliseconds();
    return isNaN(e) ? "Invalid Date" : ((t = e.getUTCFullYear()) < 0 ? "-" + pe(-t, 6) : t > 9999 ? "+" + pe(t, 6) : pe(t, 4)) + "-" + pe(e.getUTCMonth() + 1, 2) + "-" + pe(e.getUTCDate(), 2) + (o ? "T" + pe(n, 2) + ":" + pe(r, 2) + ":" + pe(i, 2) + "." + pe(o, 3) + "Z" : i ? "T" + pe(n, 2) + ":" + pe(r, 2) + ":" + pe(i, 2) + "Z" : r || n ? "T" + pe(n, 2) + ":" + pe(r, 2) + "Z" : "")
}
function me(e) {
    var t = new RegExp('["' + e + "\n\r]"),
        n = e.charCodeAt(0);
...
var ke = Ue((async function(e, t) {
    if (e.startsWith(Se) && (e = e.substring(Se.length)), /^(\w+:)|\/\//i.test(e))
        return e;
    if (/^[.]{0,2}\//i.test(e))
    ...
    if (n.path && !Ae.test(n.path) && (n.path += ".js"), n.path && n.version && Te.test(n.version))
        return `${Se}${n.name}@${n.version}/${n.path}`;
    const r = await Me(n);
    return `${Se}${r.name}@${r.version}/${n.path || function(e) {for (const t of Oe) {const n = e[t];if ("string" == typeof n)return Ae.test(n) ? n : `${n}.js`}}(r) || "index.js"}`
}));
function Ue(e) {
    const t = new Map,
        n = i(null);
...
function Re(e) {
    ...
    for (const n of e)
        for (const e in n)
            Pe.call(n, e) && (null == n[e] ? Object.defineProperty(t, e, {
                get: De(n, e)
            }) : t[e] = n[e]);
    return t
}
...
class SQLiteDatabaseClient {
    ...
    async describe(e)
    {
        ...
        return dt("table", {
            value: t
        }, [dt("thead", [dt("tr", n.map((e => dt("th", [ft(e)]))))]), dt("tbody", t.map((e => dt("tr", n.map((t => dt("td", [ft(e[t])])))))))])
    }
    async sql(e, ...t)
    {
...
class Workbook {
    ...
    sheet(e, t)
    {
        ...
        if (null == n)
            throw new Error(`Sheet not found: ${e}`);
        return function(e, {range: t, headers: n}={}) {
            let [[r, i], [o, a]] = function(e=":", {columnCount: t, rowCount: n}) {
                ...
                const [[r=0, i=0], [o=t - 1, a=n - 1]] = e.split(":").map(bt);
                return [[r, i], [o, a]]
            }(t, e);
...
async function _t(e, t, {array: n=!1, typed: r=!1}={}) {
    ...
    return ("\t" === t ? n ? ge : ye : n ? _e : ve)(i, r && xe)
}
class wt {
    constructor(e, t)
    {
    ...
    async image(e)
    {
        ...
        return new Promise(((n, r) => {
            const i = new Image;
            new URL(t, document.baseURI).origin !== new URL(location).origin && (i.crossOrigin = "anonymous"),
            Object.assign(i, e),
            i.onload = () => n(i),
    ...
    element: function(e, t) {
        ...
        if (t)
            for (var a in t)
                ...
                gt.hasOwnProperty(r) ? o.setAttributeNS(gt[r], a, n) : o.setAttribute(a, n);
        return o
    },
    input: function(e) {
...
function St(e) {
    ...
    if (null != i && "function" != typeof i)
        throw new Error("function" == typeof i.then ? "async initializers are not supported" : "initializer returned something, but not a dispose function");
    return {
        [Symbol.iterator]: $t,
        throw: () => ({
            done: !0
...
var Tt = {
    ...
    queue: function(e) {
        ...
        if (null != r && "function" != typeof r)
            throw new Error("function" == typeof r.then ? "async initializers are not supported" : "initializer returned something, but not a dispose function");
        return {
            [Symbol.iterator]: $t,
            throw: () => ({
                done: !0
        ...
        for (s = 1, c = arguments.length; s < c; ++s) {
            if ((r = arguments[s]) instanceof Node)
                ...
                for (l = 0, u = r.length; l < u; ++l)
                    (i = r[l]) instanceof Node ? (null === p && (f[++h] = p = document.createDocumentFragment(), d += "\x3c!--o:" + h + "--\x3e"), p.appendChild(i)) : (p = null, d += i);
                p = null
            } else
                d += r;
            d += n[s]
...
function Ut(e, t) {
    var n;
    return (n = kt.get(e = +e)) ? n.then((() => t)) : (n = Date.now()) >= e ? Promise.resolve(t) : function(e, t) {
    ...
    Object.defineProperties(this, (n = {
        ...
        md: () => function(e) {
            return e(Qe.resolve()).then((function(t) {
                return At((function(n) {
                    ...
                    return i.length > 0 && e(Ve.resolve()).then((function(t) {
        ...
        L: () => async function(e) {
            ...
            if (!t._style) {
                ...
                e.rel = "stylesheet",
                e.href = ct.resolve("dist/leaflet.css"),
                t._style = document.head.appendChild(e)
            }
            return t
        }(t),
...
Zt.prototype.name = "RuntimeError",
    ...
    Object.defineProperties(this, {
        ...
        _rejector: {
            value: (r = this, function(e) {
                if (e === rn)
                    throw new Zt(r._name + " is not defined", r._name);
                if (e instanceof Error && e.message)
                    throw new Zt(e.message, r._name);
...
function an(e, t, n) {
    ...
    if (this._inputs.forEach(nn, this), t.forEach(tn, this), this._inputs = t, this._definition = n, this._value = void 0, n === Qt ? i._variables.delete(this) : i._variables.add(this), e !== this._name || r.get(e) !== this) {
        ...
        if (this._outputs.size)
            throw new Error;
        e && ((a = r.get(e)) ? 3 === a._type ? (this._definition = on(e), this._duplicate = n, a._duplicates.add(this)) : 2 === a._type ? (this._outputs = a._outputs, a._outputs = new Set, this._outputs.forEach((function(e) {
            e._inputs[e._inputs.indexOf(a)] = this
        }), this), i._dirty.add(a).add(this), r.set(e, this)) : (a._duplicate = a._definition, this._duplicate = n, (o = new en(3, this._module))._name = e, o._definition = this._definition = a._definition = on(e), o._outputs = a._outputs, a._outputs = new Set, o._outputs.forEach((function(e) {
...
function sn(e, t=[]) {
    Object.defineProperties(this, {
        ...
        _builtins: {
            value: new Map([["invalidation", un], ["visibility", dn], ...t])
        },
        _source: {
            value: null,
            writable: !0
            ...
            for (const [o, a] of this._scope) {
                ...
                if (!n || 1 !== n._type)
                    if (a._definition === Kt) {
                        ...
                        e.define(o, a._inputs.map(cn), a._definition)
            }
            return e
        },
        writable: !0,
    ...
    _resolve: {
        value: function(e) {
            var t,
                n = this._scope.get(e);
            if (!n)
                if (n = new en(2, this), this._builtins.has(e))
                    n.define(e, Gt(this._builtins.get(e)));
...
function _n(e, t) {
    let n,
        ...
        a = Qt,
        s = Qt;
    return i && (r = new IntersectionObserver((([e]) => (o = e.isIntersecting) && (n = null, a()))), r.observe(i), e.then((() => (r.disconnect(), r = null, s())))), function(e) {
...
function wn(e) {
    ...
    const t = e._value,
        n = ++e._version;
    let r = null;
    const i = e._promise = (e._inputs.length ? Promise.all(e._inputs.map(bn)).then((function(i) {
        if (e._version !== n)
            return;
        ...
        if (function(e) {
            ...
            return e._version !== n ? void t.return() : ((r || vn(e)).then((i = t, function() {
                i.return()
            })), function(e, t, n) {
...
function yn(e, t) {
    ...
    ++e._version,
    e._indegree = NaN,
    (e._promise = Promise.reject(t)).catch(Qt),
    e._value = void 0,
    e._rejected(t)
}
function gn(e) {
        ...
        value: function(e, t, n) {
            ...
            for (const e of r) {
                ...
                for (const i of e.variables)
                    i.from ? t.import(i.remote, i.name, c(i.from)) : t === s ? t.variable(n(i, r, e.variables)).define(i.name, i.inputs, i.value) : t.define(i.name, i.inputs, i.value),
                    ++r
            }
            return a
        },
...
Object.defineProperties(fn.prototype, {
    ...
    module: {
        value: function(e, t=Qt) {
            let n;
            if (void 0 === e)
                return (n = this._init) ? (this._init = null, n) : new sn(this);
            if (n = this._modules.get(e), n)
                return n;
            this._init = n = new sn(this),
